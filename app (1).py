...
st.markdown("""
<style>
    /* Force light background + dark readable text regardless of browser/Streamlit theme */
    .stApp { background: #FAFAFE !important; }
    .stApp, .stApp p, .stApp span, .stApp label, .stApp div,
    h1, h2, h3, h4, h5, h6 { color: #13141C !important; }

    h1, h2, h3, h4 { font-family: 'Georgia', serif; }

    /* Metrics readable */
    div[data-testid="stMetricValue"] { font-size: 20px; font-weight: 700; color: #13141C !important; }
    div[data-testid="stMetricLabel"] { color: #6B7280 !important; }

    /* Number input fields: light box, dark text */
    div[data-baseweb="input"] input,
    .stNumberInput input { color: #13141C !important; background: #FFFFFF !important; }
    .stNumberInput button { color: #13141C !important; }
    .stTextInput input { color: #13141C !important; background: #FFFFFF !important; }

    /* Buttons: keep dark text on light button */
    .stButton button { border-radius: 10px; font-weight: 600; color: #13141C !important; background: #FFFFFF !important; border: 1px solid #E0E0EC !important; }
    .stButton button[kind="primary"] { color: #FFFFFF !important; background: #7B5CFA !important; border: none !important; }

    /* Reward box keeps its own dark bg, so white text is correct INSIDE it */
    .reward-box {
        background: linear-gradient(120deg, #1A0F3D, #2B1854 50%, #0E3D34);
        border-radius: 18px; padding: 22px 24px; margin: 12px 0 20px;
    }
    .reward-box .reward-label { font-size: 12px; color: rgba(255,255,255,0.7) !important;
        text-transform: uppercase; letter-spacing: 0.06em; font-weight: 700; margin-bottom: 6px; }
    .reward-box .reward-value { font-family: 'Georgia', serif; font-size: 30px; font-weight: 700; color: #FFB627 !important; }
    .reward-box .reward-sub { font-size: 12px; color: rgba(255,255,255,0.6) !important; margin-top: 6px; }

    /* Dataframe text */
    .stDataFrame { color: #13141C !important; }
</style>
